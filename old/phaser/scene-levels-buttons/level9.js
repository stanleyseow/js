...
create() {
    ...
    this.add.text(0,0, 'Level 9 - Mini Map', { font: '24px Courier', fill: '#ffffff' }).setScrollFactor(0);
    ...
    this.player.setScale(1).setOrigin(0,0);
...
//  The miniCam is 400px wide, so can display th6 whole world at a zoom of 0.2
    this.minimap = this.cameras.add(30, 30,270, 130).setZoom(0.1).setName('mini');
    this.minimap.setBackgroundColor(0x002244);
    this.minimap.scrollX = 1150;
...
doBack()
{
    console.log('Called mainScene from level9');
