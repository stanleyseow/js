class level1 extends Phaser.Scene {
  ...
  create() {
    ...
    this.enemy1 = this.physics.add.sprite( fire1.x, fire1.y).play('fireAnim');
    this.enemy2 = this.physics.add.sprite( fire2.x, fire2.y).play('fireAnim');
    this.enemy3 = this.physics.add.sprite( fire3.x, fire3.y).play('fireAnim');
    this.enemy4 = this.physics.add.sprite( fire4.x, fire4.y).play('fireAnim');
    ...
    this.groundLayer.setCollisionByProperty({ pillar : false });
