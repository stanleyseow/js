class world extends Phaser.Scene {
    ...
    create () {
        ...
        this.cleric = this.physics.add.sprite(100,430,'u3').play('cle').setScale(2);
        this.fighter = this.physics.add.sprite(500,350,'u3').play('fig').setScale(2);
    ...
    city1(player,tile) {
        ...
        this.scene.start('city1', { player : player });
    }
