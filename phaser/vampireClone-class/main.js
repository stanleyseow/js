...
class MainScene extends Phaser.Scene {
  ...
  // playerThrowKnife() {
  //     const knive = this.physics.add.sprite(this.player.x, this.player.y, "kniveImg")
  //     knive.play("kniveAnim")
  //     //knive.damage = playerStats.damage;
  //     knive.setActive(true);
  //     knive.setVisible(true);

  //     console.log(this.player.facing)

  //     // Shoot knives at facing direction
  //     switch (this.player.facing) {
  //       case "up":
  //         knive.setVelocityY(-100);
  //         break ;
  //       case "down":
  //         knive.setVelocityY(100);
  //         break;
  //       case "left":
  //         knive.setVelocityX(-100);
  //         break;
  //       case "right":
  //         knive.setVelocityX(100);
  //         break;
  ...
  //     console.log("Knife position:", knive.x, knive.y, "Velocity:", knive.body.velocity.x, knive.body.velocity.y);

  //     // Add to group
  //     this.knives.add(knive);     
  // }
