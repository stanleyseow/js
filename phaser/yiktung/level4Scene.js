...
preload() {
    ...
    this.load.tilemapTiledJSON('map4', 'assets/level3.json');
...
create() {
    ...
    this.startPoint3 = this.map4.findObject("Object1", obj => obj.name === "startPoint3");
    this.endPoint3 = this.map4.findObject("Object1", obj => obj.name === "endPoint3");
